...
subtitle: "Macroeconomic Dynamics and Educational Attainment: A Predictive Framework"
format:
  html:
    toc: true
---
...
### Evaluating Conditional Expectations of Higher Education Outcomes Across Economic Growth Regimes
:::
...
summary_table <- tibble(
  Variable = c("income_growth_pct", "gdp_growth_pct", "edu_investment_pct", 
               "bachelors_plus_pct", "hs_completion_pct", "avg_years_schooling",
               "income_tier", "education_tier"),
  `Variable Type` = c("Continuous (%)", "Continuous (%)", "Continuous (%)", 
                      "Continuous (%)", "Continuous (%)", "Continuous (Years)",
                      "Categorical", "Categorical"),
  Description = c("Year-over-Year Real Median Household Income Growth (%)",
                  "Year-over-Year Gross Domestic Product Growth (%)",
                  "Year-over-Year State Higher Education & Research Investment Growth (%)",
                  ...
                  "Income Growth Regime: Low (<1.0%), Moderate (1.0-3.0%), High (3.0%+)",
  ...
  Range = c(
    ...
    paste0("[", min(df$edu_investment_pct), ", ", max(df$edu_investment_pct), "]"),
...
- **Outcome Variables**: Continuous degree completion percentage (`bachelors_plus_pct`), average schooling years (`avg_years_schooling`), and ordinal attainment tiers (`education_tier`).
:::
