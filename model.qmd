...
## 2. Model Estimation & 95% Confidence Intervals
  > **Note**: The following tables (3.2 & 3.3) are shortened tables with only the most statistically significant covariates. The complete parameter table across all predictors and outcome tiers can be found in Section 3 of the [Sources](sources.qmd) tab.
